...
var theMostFamous = log.Values.Where(x=>x.ContainsKey("followers")).OrderByDescending(x=>x.Values).ThenBy(x=>x.ContainsKey("following")).FirstOrDefault();

Console.WriteLine(string.Join(" ", theMostFamous));
